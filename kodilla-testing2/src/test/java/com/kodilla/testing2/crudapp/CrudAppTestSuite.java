...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://msfaxe.github.io/";
    ...
    private String createCrudAppTestTask() throws InterruptedException {
        ...
        final String XPATH_ADD_BUTTUN = "//form[contains(@action, \"createTask\")]//button[1]";
        ...
        WebElement addButton = driver.findElement(By.xpath(XPATH_ADD_BUTTUN));
        addButton.click();
        Thread.sleep(2000);
